...
public interface TarbaloListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterDeclaracaoVetor(TarbaloParser.DeclaracaoVetorContext ctx);
	/**
	 * Exit a parse tree produced by {@link TarbaloParser#declaracaoVetor}.
	 * @param ctx the parse tree
	 */
	void exitDeclaracaoVetor(TarbaloParser.DeclaracaoVetorContext ctx);
	/**
	 * Enter a parse tree produced by {@link TarbaloParser#inicializacaoVetor}.
	 * @param ctx the parse tree
	 */
	void enterInicializacaoVetor(TarbaloParser.InicializacaoVetorContext ctx);
	/**
	 * Exit a parse tree produced by {@link TarbaloParser#inicializacaoVetor}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link TarbaloParser#incrementoPonto}.
	 * @param ctx the parse tree
	 */
	void enterIncrementoPonto(TarbaloParser.IncrementoPontoContext ctx);
	/**
	 * Exit a parse tree produced by {@link TarbaloParser#incrementoPonto}.
	 * @param ctx the parse tree
	 */
	void exitIncrementoPonto(TarbaloParser.IncrementoPontoContext ctx);
	/**
	 * Enter a parse tree produced by {@link TarbaloParser#decrementoPonto}.
	 * @param ctx the parse tree
	 */
	void enterDecrementoPonto(TarbaloParser.DecrementoPontoContext ctx);
	/**
	 * Exit a parse tree produced by {@link TarbaloParser#decrementoPonto}.
	 * @param ctx the parse tree
	 */
	void exitDecrementoPonto(TarbaloParser.DecrementoPontoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TarbaloParser#cmdParaCada}.
	 * @param ctx the parse tree
	 */
	void enterCmdParaCada(TarbaloParser.CmdParaCadaContext ctx);
	/**
	 * Exit a parse tree produced by {@link TarbaloParser#cmdParaCada}.
	 * @param ctx the parse tree
	 */
	void exitCmdParaCada(TarbaloParser.CmdParaCadaContext ctx);
	/**
