...
public class TarbaloLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INICIO", "FIM", "VARIAVEL", "VETOR", "INTEIRO", "DECIMAL", "CARACTERE", 
			...
			"VIRGULA", "PONTIVIRGULA", "PONTO", "NUMDEC", "NUM", "CHAR", "ESCAPE_CHAR", 
			"STRING", "ESCAPE_STRING", "ID", "COMENTARIO_LINHA", "COMENTARIO_BLOCO", 
			"WS"
		};
	}
